namespace FlopManager.Services
{
    ...
    {
        public const string FAMILY_DB_PATH = "FamilyDbPath";
        public const string CONFIRM_EXIST_MSG = "هل تريد الخروج بدون حفظ؟";
        public const string CONFIRM_ACTION_TITLE = "تأكيد";
        public const string NOTIFY_ACTION_TITLE = "Flop Manager";
        public const string CONFIRM_POST_MSG = "بعد ترحيل الدفعة لن تتمكن من إجراء أي تغيير." + "\n" + "هل تريد المتابعة؟";
        public const string PAYMENT_NOT_EXIST_MSG = "الدفعة غير موجودة";
